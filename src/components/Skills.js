      ...
      <div className="Skills">
        <div className="frontendSkills">
          ...
          <ul>
            ...
            <li><img src="https://img.icons8.com/ios-filled/50/000000/jquery.png"/>jQuery</li>
        ...
        <div className="backendSkills">
          ...
          <ul>
            <li><img src="https://img.icons8.com/plumpy/48/000000/test-tube.png"/>Flask</li>
            ...
            <li><img src="https://img.icons8.com/color/48/000000/api.png"/>REST API</li>
          </ul>
        </div>
        <div className="otherSkills">
          <h1 className="titleSkills">Other</h1>
          <ul>
            <li><img src="https://img.icons8.com/color/48/000000/git.png"/>Git</li>
            <li><img src="https://img.icons8.com/fluent/48/000000/github.png"/>Github</li>
            <li><img src="https://img.icons8.com/color/48/000000/heroku.png"/>Heroku</li>
            <li><img src="https://img.icons8.com/fluent/48/000000/adobe-photoshop.png"/>Adobe Photoshop</li>
            <li><img src="https://img.icons8.com/color/48/000000/adobe-illustrator.png"/>Adobe Illustrator</li>
          </ul>
        </div>
      </div>
    );
